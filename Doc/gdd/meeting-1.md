...
| Prinyakorn     | Enemy Sprite        | 🔄 In Progress | 25/9             |
| Prinyakorn     | UI                  | ✅ Done        |                  |
...
| Patcharapakorn | map dynamic          | 🔄 In Progress | 23/9             |
| Patcharapakorn | weapon variety       | 🔄 In Progress | 23/9             |
| Prinyakorn     | Combat VFX animation | 🔄 In Progress | 24/9             |
...
| Features                | คำอธิบาย                                      |
| ----------------------- | ----------------------------------------------------- |
| Base Building/Upgrading | player can upgrade base with their material           |
| Events                  | Player get events when starting new day               |
| Explore                 | Player can now explore at night                       |
| Prepare                 | Player can choose weapon before exploring             |
| Enemy Battle            | Player can get encounter with monster while exploring |
