...
| 3 | As a player, I want to see my remaining health, so that I know how close I am to game over     | [ปริญญากร] | Should Have | 5             | ✅ Done         |
| 4 | As a player, I want to see my what weapon I'm using, so that i'll know how much damage they do | [ปริญญากร] | Should Have | 4             | 🔄 In Progress  |
...
* [ ] [UI/UX]  [owner:: ปริญญากร]  [domain:: Artist]  [estimate:: 6 hours]  [status:: Done]
...
**เมื่อวาน:** ทำ UI combat เสร็จ
**วันนี้:** ทำ Animation vfx
**Blocked:** ...
